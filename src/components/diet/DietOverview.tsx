...
export const DietOverview: React.FC<DietOverviewProps> = ({
  refreshTrigger = 0,
}) => {
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between text-[10px]">
                ...
                <span className="font-semibold text-blue-500">
                  {Math.round(
                    calculatePercentage(todayStats.water, todayStats.waterGoal)
                  )}
                  %
                </span>
              </div>
              ...
              <div className="h-full flex flex-col justify-center items-center p-5 text-center">
                ...
                <p className="text-[10px] text-gray-500">
                  {todayStats.calories < todayStats.calorieGoal
                    ? `${
                        todayStats.calorieGoal - todayStats.calories
                      } kcal remaining`
                    : "Daily goal reached!"}
                </p>
              </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between text-[10px]">
                ...
                <span className="font-semibold text-orange-500">
                  {todayStats.caloriesBurned} kcal
                </span>
              </div>
              <div className="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.min(
                      (todayStats.caloriesBurned / 500) * 100,
                      100
                    )}%`,
                  }}
                ></div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-lg font-bold text-green-600">
                  {Math.max(0, todayStats.calorieGoal - todayStats.calories)}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl border border-orange-200 shadow-sm p-6 sticky top-6">
          ...
          <div className="bg-white rounded-xl p-4 mb-4">
            ...
            <p className="text-xs text-gray-600">
              From {todayHabits.length} completed habit
              {todayHabits.length !== 1 ? "s" : ""} today
            </p>
          </div>
